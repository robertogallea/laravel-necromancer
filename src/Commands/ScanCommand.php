...
final class ScanCommand extends Command
{
    ...
    protected $signature = 'necromancer:scan
        ...
        {--only=          : Comma-separated artifact types to collect (routes,models,requests,jobs,events,listeners,commands,policies,enums,tests,observers,scheduled_tasks,middleware,livewire_components,gates,mailables,validation_rules)}
